...
public class CommandManager {
    ...
    private AbstractCommand switchOffUser;
    ...
    public boolean switch_off_user(String argument, Object objectArgument, User user) {
        return switchOffUser.execute(argument, objectArgument, user);
    }
}
